...
function getDaysToLocation(kilometersAway: number): number {
    let milesToDestination: number = kilometersAway * 0.621;
    let hoursToDestination: number = milesToDestination / 17500;
...
console.log(`\n${spaceShuttle.name} would take ${spaceShuttle.getDaysToLocation(kilometersToMars)} days to get to Mars.`);
