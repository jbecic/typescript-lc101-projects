...
console.log("\n".concat(spacecraftName, " would take ").concat(daysToMars, " days to get to Mars."));
// Part 3: Create a Function ("getDaysToLocation")
function getDaysToLocation(kilometersAway) {
    var milesToDestination = kilometersAway * 0.621;
    var hoursToDestination = milesToDestination / 17500;
    var daysToDestination = hoursToDestination / 24;
    return daysToDestination;
}
// Move your output statement from part 2 here. Update the template literal to call
// the function and print the outputs for a Mars trip and a moon trip.
console.log("\n".concat(spacecraftName, " would take ").concat(getDaysToLocation(kilometersToMars), " days to get to Mars."));
...
console.log("\n".concat(spaceShuttle.name, " would take ").concat(spaceShuttle.getDaysToLocation(kilometersToMars), " days to get to Mars."));
